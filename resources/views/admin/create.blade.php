        ...
        <form class="col-8 m-auto text-white" action="{{ route('admin.store') }}" method="POST">
            ...
            <div class="form-group m-2">
                ...
                <input type="text" class="form-control" id="shoreLocation" name="type"
                    placeholder="Enter the location of your company" value="{{ old('type') }}">
            </div>
            <div class="form-group m-2">
            ...
            <div class="form-group m-2">
                ...
                <input type="text" class="form-control" id="shoreOpening" name="start_date"
                    placeholder="Enter the opening date" value="{{ old('start_date') }}">
            </div>
            <div class="form-group m-2">
                <label for="shoreClosing">End Date</label>
                <input type="text" class="form-control" id="shoreClosing" name="end_date"
                    placeholder="Enter the closing date" value="{{ old('end_date') }}">
            </div>
            <div class="button">
